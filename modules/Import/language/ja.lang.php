...
$mod_strings = array (
    ...
    'LBL_JIGSAW' => 'Jigsaw',
    'LBL_IMPORT_JIGSAW_TITLE' => '多くのアプリケーションは以下の一般的な手順で<b>カンマ区切りのテキストファイル (.csv)</b>へインポートすることができます。:',
    'LBL_JIGSAW_NUM_1' => 'アプリケーションを起動しエクスポートしたいファイルを開きます。',
    'LBL_JIGSAW_NUM_2' => '<b>形式を指定して保存...</b>もしくは<b>エクスポート...</b>メニューオプションを選択します。',
    'LBL_JIGSAW_NUM_3' => '<b>CSV</b>もしくは<b>カンマ区切り</b>フォーマットでファイルに保存します。',
    'LBL_IMPORT_STARTED' => 'インポート開始:',
    'LBL_RECORD_CANNOT_BE_UPDATED' => '権限が無いため、レコードを更新できません。',
    // OSC add - start
    'LBL_RFC4180' => 'RFC4180',
    'LBL_DELIMITER_RFC4180_HELP' => 'RFC4180にしたがったファイルをインポートする場合はこのオプションを選択してください。',
    // OSC add - end
);